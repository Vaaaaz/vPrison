...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public static boolean intersectsCuboid(Cuboid a, Cuboid b) {
        if (!intersectsDimension(a.getLowerX(), a.getUpperX(), b.getLowerX(), b.getUpperX()))
            return false;

        if (!intersectsDimension(a.getLowerY(), a.getUpperY(), b.getLowerY(), b.getUpperY()))
            return false;

        if (!intersectsDimension(a.getLowerZ(), a.getUpperZ(), b.getLowerZ(), b.getUpperZ()))
            return false;

        return true;
    }

    public static boolean intersectsDimension(int aMin, int aMax, int bMin, int bMax) {
